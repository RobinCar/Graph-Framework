...
/**
 * This class represents the undirected graphs structured by an adjacency
 * matrix. It is possible to have simple and multiple graph
 */
public class AdjacencyMatrixUndirectedGraph extends AbstractMatrixGraph<UndirectedNode> implements IUndirectedGraph {
	...
	public void removeEdge(AbstractNode x, AbstractNode y) {
		if (this.matrix[x.getLabel()][y.getLabel()] > 0) {
	...
	public static void main(String[] args) {
		...
		am.addEdge(new UndirectedNode(2), new UndirectedNode(3));
		am.addEdge(new UndirectedNode(2), new UndirectedNode(3));
		am.addEdge(new UndirectedNode(2), new UndirectedNode(3));
		System.out.println();
		System.out.println(am);
		am.removeEdge(new UndirectedNode(2), new UndirectedNode(3));
		System.out.println();
		System.out.println(am);
		System.out.println();
		System.out.println(am.isEdge(new UndirectedNode(2), new UndirectedNode(3)));
	}
}
